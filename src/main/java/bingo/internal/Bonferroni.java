...
//	private int maxValue;
	 ...
	 * Constructor.
	 * 
	 * @param golabelstopvalues
	 *            Hashmap of Strings with the goLabels and their pvalues.
	 * @param alpha
	 *            String with the alpha-level.
	 */
...
//		this.maxValue = pvalues.length;
	...
	class HashComparator implements java.util.Comparator {
		...
		/*
		 * public boolean equals(Object o){ return ((Object)this).equals(o) ; }
		 */
	}
	...
	/**
	 * method that calculates the bonferroni procedure p< alpha/m i* (istar)
