...
public class BiNGOAnnotationFlatFileReader {
	...
	public BiNGOAnnotationFlatFileReader(File file, Map synonymHash) throws IllegalArgumentException, IOException,
			Exception {
	...
	public BiNGOAnnotationFlatFileReader(String filename, Map synonymHash) throws IllegalArgumentException,
